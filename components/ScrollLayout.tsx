...
// Hoisted SVG path data for the canvas expand/collapse button — string
// literals that don't depend on render state and don't need re-allocation.
const COLLAPSE_ICON_D =
...
export function ScrollLayout({
  ...
  const visualEntries = useMemo(() => Object.entries(visuals), [visuals]);
  const resolvedVisual = activeVisual ?? visualEntries[0]?.[0] ?? null;
                ...
                <div className="canvas__toolbar">
                  ...
                  >
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d={expanded ? COLLAPSE_ICON_D : EXPAND_ICON_D} />
                    </svg>
                  </button>
                </div>
