...
## [Tips for using Copilot CLI programmatically](#tips-for-using-copilot-cli-programmatically)
...
## [Examples of programmatic usage](#examples-of-programmatic-usage)
...
### [Summarize a file](#summarize-a-file)

```bash
copilot -p 'Summarize what src/auth/login.ts does in no more than 100 words' -s
```

### [Write tests for a module](#write-tests-for-a-module)
...
### [Export a session](#export-a-session)
...
### [Capture Copilot's output in a variable](#capture-copilots-output-in-a-variable)
...
### [Use in a conditional](#use-in-a-conditional)
