...
## [About Copilot code referencing in JetBrains IDEs](#about-copilot-code-referencing-in-jetbrains-ides)
...
### [Code referencing for Copilot inline suggestions](#code-referencing-for-copilot-inline-suggestions)
...
### [Code referencing for Copilot Chat](#code-referencing-for-copilot-chat)
...
## [About Copilot code referencing in Visual Studio Code](#about-copilot-code-referencing-in-visual-studio-code)
...
### [Code referencing for Copilot inline suggestions](#code-referencing-for-copilot-inline-suggestions-1)
...
### [Code referencing for Copilot Chat](#code-referencing-for-copilot-chat-1)

When Copilot Chat provides a response that includes code that matches code in a public GitHub repository, this is indicated at the end of the response with a link to display details of the matched code in the editor.

## [About Copilot code referencing on GitHub.com](#about-copilot-code-referencing-on-githubcom)

### [Code referencing for Copilot Chat](#code-referencing-for-copilot-chat-2)
...
### [Code referencing for Copilot coding agent](#code-referencing-for-copilot-coding-agent)

When Copilot generates code that matches code in a public GitHub repository, this is indicated in the agent session logs with a link to display details of the matched code. For more information, see [Tracking GitHub Copilot's sessions](/en/copilot/how-tos/use-copilot-agents/coding-agent/track-copilot-sessions).

## [About Copilot code referencing in Visual Studio](#about-copilot-code-referencing-in-visual-studio)
...
### [Code referencing for Copilot inline suggestions](#code-referencing-for-copilot-inline-suggestions-2)
...
### [Code referencing for Copilot Chat](#code-referencing-for-copilot-chat-3)
...
## [How code referencing finds matching code](#how-code-referencing-finds-matching-code)
...
References to matching code are currently available in JetBrains IDEs, Visual Studio, Visual Studio Code, Copilot coding agent, and on the GitHub website.
