...
-   **Get free access if you're eligible.** Students, teachers, and open source maintainers may qualify for access to premium features at no cost. See [Access GitHub Copilot for free as a student](/en/copilot/how-tos/manage-your-account/free-access-with-copilot-student) and [Getting free access to GitHub Copilot Pro as a teacher or maintainer](/en/copilot/managing-copilot/managing-copilot-as-an-individual-subscriber/getting-free-access-to-copilot-as-a-student-teacher-or-maintainer).
...
### [Organizations and enterprises](#organizations-and-enterprises)

**Organization owners** can purchase Copilot Business for their team. See [Subscribing to GitHub Copilot for your organization](/en/copilot/managing-copilot/managing-github-copilot-in-your-organization/subscribing-to-copilot-for-your-organization).
...
**Enterprise owners** can purchase Copilot Business or Copilot Enterprise for your enterprise. See [Subscribing to GitHub Copilot for your enterprise](/en/copilot/managing-copilot/managing-copilot-for-your-enterprise/subscribing-to-copilot-for-your-enterprise).
