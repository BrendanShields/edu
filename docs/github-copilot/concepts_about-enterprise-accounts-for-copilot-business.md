...
## [How can my enterprise use GitHub Copilot only?](#how-can-my-enterprise-use-github-copilot-only)
...
## [How will I manage access for users?](#how-will-i-manage-access-for-users)
...
### [Enterprise Managed Users](#enterprise-managed-users)
...
To get started, see [Setting up a dedicated enterprise for GitHub Copilot Business](/en/copilot/how-tos/set-up/set-up-a-dedicated-enterprise-for-copilot-business).