...
## [Approach 1: Use GitHub's "request access" feature](#approach-1-use-githubs-request-access-feature)
...
2.  Members of the organization go to their personal settings page at [https://github.com/settings/copilot](https://github.com/settings/copilot) and click **Ask admin for access**.
...
## [Approach 2: Integrate with the API](#approach-2-integrate-with-the-api)
