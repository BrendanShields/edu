...
## [Understand Copilot's strengths and weaknesses](#understand-copilots-strengths-and-weaknesses)
...
## [Choose the right Copilot tool for the job](#choose-the-right-copilot-tool-for-the-job)
...
## [Create thoughtful prompts](#create-thoughtful-prompts)
...
## [Check Copilot's work](#check-copilots-work)
...
## [Guide Copilot towards helpful outputs](#guide-copilot-towards-helpful-outputs)
...
## [Stay up-to-date on Copilot's features](#stay-up-to-date-on-copilots-features)
