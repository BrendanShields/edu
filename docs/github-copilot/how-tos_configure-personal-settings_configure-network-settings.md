...
## [Configuring proxy settings for Copilot](#configuring-proxy-settings-for-copilot)
...
### [Overriding the default SPN in VS Code](#overriding-the-default-spn-in-vs-code)
...
### [Overriding the default SPN in JetBrains IDEs](#overriding-the-default-spn-in-jetbrains-ides)
...
## [Installing custom certificates](#installing-custom-certificates)
