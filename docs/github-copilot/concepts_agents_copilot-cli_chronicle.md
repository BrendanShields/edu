...
## [How session data is stored](#how-session-data-is-stored)
...
### [Privacy and data locality](#privacy-and-data-locality)
...
## [About the `/chronicle` slash command](#about-the-chronicle-slash-command)
...
## [Benefits of `/chronicle` and the session data](#benefits-of-chronicle-and-the-session-data)
...
## [When should you use these features?](#when-should-you-use-these-features)
...
## [Reindexing the session store](#reindexing-the-session-store)
