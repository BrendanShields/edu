...
## [Current enforcement limitations](#current-enforcement-limitations)
...
## [Enforcement for local servers](#enforcement-for-local-servers)
...
## [Policy resolution for users with multiple seats](#policy-resolution-for-users-with-multiple-seats)
