...
## [Creating a custom agent profile in a repository on GitHub](#creating-a-custom-agent-profile-in-a-repository-on-github)
...
4.  Click , then click **Create an agent**. This will open a template agent profile called `my-agent.agent.md` in the `.github/agents` directory of your target repository.
...
## [Creating a custom agent profile in Visual Studio Code](#creating-a-custom-agent-profile-in-visual-studio-code)
...
## [Creating a custom agent profile in JetBrains IDEs](#creating-a-custom-agent-profile-in-jetbrains-ides)
...
## [Creating a custom agent profile in Eclipse](#creating-a-custom-agent-profile-in-eclipse)
...
## [Creating a custom agent profile in Xcode](#creating-a-custom-agent-profile-in-xcode)
