...
## [Benefits of autopilot mode](#benefits-of-autopilot-mode)
...
## [Comparing autopilot mode, `--allow-all`, and `--no-ask-user`](#comparing-autopilot-mode---allow-all-and---no-ask-user)
...
## [Typical workflow for using autopilot mode](#typical-workflow-for-using-autopilot-mode)
...
## [Using autopilot mode programmatically](#using-autopilot-mode-programmatically)
