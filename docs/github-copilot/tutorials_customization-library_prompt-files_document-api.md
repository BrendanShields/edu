...
## [OpenAPI specification prompt](#openapi-specification-prompt)
...
Focus on: ${input:endpoint\_focus:Which specific endpoint or endpoints should be documented?}
...
## [How to use this prompt file](#how-to-use-this-prompt-file)
