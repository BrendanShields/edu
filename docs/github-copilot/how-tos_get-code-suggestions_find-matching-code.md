...
## [View code references for inline suggestions](#view-code-references-for-inline-suggestions)
...
### [Verifying the code referencing functionality](#verifying-the-code-referencing-functionality)
...
## [View code references for inline suggestions](#view-code-references-for-inline-suggestions-1)
...
### [Example log entry](#example-log-entry-1)
...
### [Verifying the code referencing functionality](#verifying-the-code-referencing-functionality-1)
...
## [View code references for inline suggestions](#view-code-references-for-inline-suggestions-2)
...
### [Example log entry](#example-log-entry-2)
...
### [Verifying the code referencing functionality](#verifying-the-code-referencing-functionality-2)
...
## [View code references for Copilot Chat](#view-code-references-for-copilot-chat)
...
## [View code references for Copilot Chat](#view-code-references-for-copilot-chat-1)
...
1.  Click the "Public code references..." text, under the code suggestion.
    ...
    ![Screenshot of an inline suggestion in Copilot Chat with a link to view code references.](/assets/cb-29389/images/help/copilot/code-reference-dotcom.png)
    
2.  Click the name of a repository to display that repository on GitHub.com.
    

## [View code references for Copilot coding agent](#view-code-references-for-copilot-coding-agent)

When Copilot provides a response that includes code that matches code in a public GitHub repository, this is indicated in the agent session logs with a link to display details of the matched code. For more information, see [Tracking GitHub Copilot's sessions](/en/copilot/how-tos/use-copilot-agents/coding-agent/track-copilot-sessions).
