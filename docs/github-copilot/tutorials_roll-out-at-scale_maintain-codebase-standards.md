...
## [1\. Require pull requests and reviews](#1-require-pull-requests-and-reviews)
...
## [2\. Test your code](#2-test-your-code)
...
## [3\. Scan code for vulnerabilities](#3-scan-code-for-vulnerabilities)

Copilot is already designed to avoid introducing vulnerabilities into your codebase. For example, code created by Copilot coding agent is automatically scanned for vulnerable patterns and secrets such as API keys.
...
1.  As a starting point, apply and enforce the **GitHub-recommended security configuration** on your organizations. This is a collection of enablement settings for security features including code scanning, secret scanning, and secrets push protection. See [Creating a custom security configuration](/en/code-security/how-tos/secure-at-scale/configure-organization-security/establish-complete-coverage/applying-the-github-recommended-security-configuration-in-your-organization).
2.  As you learn more about your needs, create custom configurations or apply granular settings at the repository level.
3.  To enforce code scanning on pull requests, go back to your ruleset and enable the **Require code scanning results** rule.

## [4\. Create guidelines for Copilot](#4-create-guidelines-for-copilot)
...
## [5\. Encourage best practices](#5-encourage-best-practices)
...
## [6\. Plan for the worst](#6-plan-for-the-worst)
...
## [7\. Check code quality](#7-check-code-quality)
...
Understand how your enterprise can use the audit log to monitor changes to configuration settings and license assignment. See [Reviewing audit logs for GitHub Copilot Business](/en/copilot/how-tos/administer-copilot/manage-for-organization/review-activity/review-audit-logs).