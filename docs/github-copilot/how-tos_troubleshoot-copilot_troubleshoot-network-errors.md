...
## [Troubleshooting proxy errors](#troubleshooting-proxy-errors)
...
If you are an employee of a company with a proxy server, your company must also configure proxy settings for Copilot at the company level. See [Copilot allowlist reference](/en/copilot/managing-copilot/managing-github-copilot-in-your-organization/configuring-your-proxy-server-or-firewall-for-copilot).
...
### [Troubleshooting security software-related certificate errors](#troubleshooting-security-software-related-certificate-errors)
