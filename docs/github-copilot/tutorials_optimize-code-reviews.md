...
Copilot code review is available for Copilot Pro, GitHub Copilot Pro+, Copilot Business and Copilot Enterprise. See [Copilot plans](https://github.com/features/copilot/plans?ref_product=copilot&ref_type=purchase&ref_style=text).
...
## [1\. Improve review quality from Copilot](#1-improve-review-quality-from-copilot)
...
## [2\. Automate reviews to address style conventions and performance](#2-automate-reviews-to-address-style-conventions-and-performance)
...
## [3\. Flag security vulnerabilities and fix them](#3-flag-security-vulnerabilities-and-fix-them)
...
## [Optimized reviews with Copilot](#optimized-reviews-with-copilot)
...
2.  To enable automatic Copilot code review for your repository, see [Configuring automatic code review by GitHub Copilot](/en/copilot/how-tos/use-copilot-agents/request-a-code-review/configure-automatic-review).
