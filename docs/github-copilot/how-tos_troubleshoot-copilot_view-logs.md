...
### [Collect log files from Rider](#collect-log-files-from-rider)
...
1.  In the menu bar, click **Help**, select **Diagnostic Tools**, and click **Debug Log Settings...**.
    ...
    ![Screenshot of the menu bar in a JetBrains IDE. The "Help" menu and "Diagnostic Tools" submenu are expanded and "Debug Log Settings" is highlighted.](/assets/cb-339281/images/help/copilot/jetbrains-debug-log.png)
...
## [Viewing network connectivity diagnostics logs](#viewing-network-connectivity-diagnostics-logs)
...
## [Troubleshooting certificate-related errors](#troubleshooting-certificate-related-errors)
...
## [Viewing logs in Visual Studio](#viewing-logs-in-visual-studio)
...
## [Viewing and collecting log files](#viewing-and-collecting-log-files)
...
## [Enabling debug mode](#enabling-debug-mode-1)
...
## [Viewing network connectivity diagnostics logs](#viewing-network-connectivity-diagnostics-logs-1)
...
3.  In the Developer Tools window, select the **Console** tab to see any errors or warnings.
    ...
    ![Screenshot of the Developer Tools window in Visual Studio Code. The console tab is outlined in dark orange.](/assets/cb-29810/images/help/copilot/vsc-electron-logs.png)
...
## [Checking if GitHub Copilot is operational](#checking-if-github-copilot-is-operational)
...
## [Collecting log files](#collecting-log-files-1)
...
## [Enabling verbose logs](#enabling-verbose-logs)
