...
### [Asking Copilot coding agent to generate a `copilot-instructions.md` file](#asking-copilot-coding-agent-to-generate-a-copilot-instructionsmd-file)
...
## [Prerequisites for repository custom instructions](#prerequisites-for-repository-custom-instructions-1)
...
## [Creating custom instructions](#creating-custom-instructions-1)
...
## [Creating repository-wide custom instructions](#creating-repository-wide-custom-instructions-1)
...
## [Creating path-specific custom instructions](#creating-path-specific-custom-instructions-1)
...
## [Custom instructions in use](#custom-instructions-in-use-1)
...
![Screenshot of an expanded References list, showing the 'copilot-instructions.md' file highlighted with a dark orange outline.](/assets/cb-28337/images/help/copilot/custom-instructions-vscode.png)

## [Enabling or disabling repository custom instructions](#enabling-or-disabling-repository-custom-instructions)

You can choose whether or not you want Copilot to use repository-based custom instructions.

### [Enabling or disabling custom instructions for Copilot Chat](#enabling-or-disabling-custom-instructions-for-copilot-chat)
...
### [Enabling or disabling custom instructions for Copilot code review](#enabling-or-disabling-custom-instructions-for-copilot-code-review-1)
...
### [Enabling prompt files](#enabling-prompt-files)
...
## [Prerequisites for repository custom instructions](#prerequisites-for-repository-custom-instructions-2)
...
## [Creating custom instructions](#creating-custom-instructions-2)
...
## [Creating repository-wide custom instructions](#creating-repository-wide-custom-instructions-2)
...
## [Creating path-specific custom instructions](#creating-path-specific-custom-instructions-2)
...
## [Custom instructions in use](#custom-instructions-in-use-2)

The instructions in the file(s) are available for use by Copilot as soon as you save the file(s). Instructions are automatically added to requests that you submit to Copilot.

Custom instructions are not visible in the Chat view or inline chat, but you can verify that they are being used by Copilot by looking at the References list of a response in the Chat view. If custom instructions were added to the prompt that was sent to the model, the `.github/copilot-instructions.md` file is listed as a reference. You can click the reference to open the file.

![Screenshot of the References popup, showing the 'copilot-instructions.md' file highlighted with a dark orange outline.](/assets/cb-24107/images/help/copilot/custom-instruction-ref-visual-studio.png)

## [Enabling or disabling repository custom instructions](#enabling-or-disabling-repository-custom-instructions-1)

You can choose whether or not you want Copilot to use repository-based custom instructions.

### [Enabling or disabling custom instructions for Copilot Chat](#enabling-or-disabling-custom-instructions-for-copilot-chat-1)
...
3.  Select or clear the checkbox for **Enable custom instructions to be loaded from .github/copilot-instructions.md files and added to requests**.
    ...
    ![Screenshot of the Visual Studio Options dialog showing the "Enable custom instructions" option checkbox selected.](/assets/cb-102746/images/help/copilot/vs-custom-instructions-option.png)
    

### [Enabling or disabling custom instructions for Copilot code review](#enabling-or-disabling-custom-instructions-for-copilot-code-review-2)
...
## [Using prompt files](#using-prompt-files-1)
...
### [Creating prompt files](#creating-prompt-files-1)
...
## [Prerequisites for repository custom instructions](#prerequisites-for-repository-custom-instructions-3)
...
## [Creating custom instructions](#creating-custom-instructions-3)
...
### [Manually creating a workspace custom instructions file](#manually-creating-a-workspace-custom-instructions-file)
...
### [Manually creating a global custom instructions file](#manually-creating-a-global-custom-instructions-file)
...
## [Custom instructions in use](#custom-instructions-in-use-3)

The instructions in the file(s) are available for use by Copilot as soon as you save the file(s). Instructions are automatically added to requests that you submit to Copilot.

Custom instructions are not visible in the Chat view or inline chat, but you can verify that they are being used by Copilot by looking at the References list of a response in the Chat view. If custom instructions were added to the prompt that was sent to the model, the `.github/copilot-instructions.md` file is listed as a reference. You can click the reference to open the file.

## [Using prompt files](#using-prompt-files-2)
...
### [Creating prompt files using the command line](#creating-prompt-files-using-the-command-line)
...
### [Creating prompt files using the settings page](#creating-prompt-files-using-the-settings-page)
...
### [Using prompt files](#using-prompt-files-3)
...
## [Prerequisites for repository custom instructions](#prerequisites-for-repository-custom-instructions-4)
...
## [Creating custom instructions](#creating-custom-instructions-4)
...
## [Custom instructions in use](#custom-instructions-in-use-4)
...
## [Prerequisites for repository custom instructions](#prerequisites-for-repository-custom-instructions-5)
...
## [Creating custom instructions](#creating-custom-instructions-5)
...
### [Creating a workspace custom instructions file](#creating-a-workspace-custom-instructions-file)
...
### [Creating a project custom instructions file](#creating-a-project-custom-instructions-file)
...
## [Custom instructions in use](#custom-instructions-in-use-5)
