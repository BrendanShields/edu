...
Owners of organizations or enterprises with a Copilot Business or Copilot Enterprise subscription can decide whether to grant access to GitHub Copilot in Windows Terminal for users in their organization or enterprise under the GitHub Copilot CLI policy.

Copy as Markdown

## In this article

## [About GitHub Copilot in Windows Terminal](#about-github-copilot-in-windows-terminal)
...
## [Use cases for GitHub Copilot in Windows Terminal](#use-cases-for-github-copilot-in-windows-terminal)

GitHub Copilot in Terminal Chat can help you by providing either command suggestions or explanations of given commands.

### [Find the right command to perform a task](#find-the-right-command-to-perform-a-task)
...
### [Explain an unfamiliar command](#explain-an-unfamiliar-command)
...
## [Improving GitHub Copilot in Windows Terminal](#improving-github-copilot-in-windows-terminal)
...
### [Use GitHub Copilot as a tool, not a replacement](#use-github-copilot-as-a-tool-not-a-replacement)
...
## [Limitations of GitHub Copilot in Windows Terminal](#limitations-of-github-copilot-in-windows-terminal)
...
### [Differing performance based on natural language](#differing-performance-based-on-natural-language)
