...
## [About Copilot's agentic capabilities and MCP](#about-copilots-agentic-capabilities-and-mcp)
...
### [Benefits of combining MCP with agent mode](#benefits-of-combining-mcp-with-agent-mode)
...
## [Best practices for using MCP with agent mode](#best-practices-for-using-mcp-with-agent-mode)
...
## [Example scenario: Implementing accessibility compliance](#example-scenario-implementing-accessibility-compliance)
...
I need to make our customer portal WCAG 2.1 AA compliant. Use the Figma MCP to analyze our design specifications at https://figma.com/design/DESIGN-FILE-FOR-ACCESSIBILITY-SPECS?node-id=NODE\_ID for accessibility requirements. Also use the GitHub MCP to find open GitHub issues with the labels accessibility or WCAG in the customer-portal repository. Then sort them into categories and list each issue that falls under the category with the issue title and number.
...
#### [Example response 3](#example-response-3)
