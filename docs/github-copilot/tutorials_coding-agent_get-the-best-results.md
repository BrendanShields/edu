...
## [Making sure your issues are well-scoped](#making-sure-your-issues-are-well-scoped)
...
## [Choosing the right type of tasks to give to Copilot](#choosing-the-right-type-of-tasks-to-give-to-copilot)
...
## [Using comments to iterate on a pull request](#using-comments-to-iterate-on-a-pull-request)
...
You can also mention `@copilot` in comments on the pull request—explaining what you think is incorrect, or could be improved—and Copilot will push commits directly to the pull request's branch. Alternatively, you can work on the feature branch yourself and push changes to the pull request.
...
## [Adding custom instructions to your repository](#adding-custom-instructions-to-your-repository)
...
### [Repository-wide instructions](#repository-wide-instructions)
...
## [Organization-wide custom instructions](#organization-wide-custom-instructions)
...
## [Using the Model Context Protocol (MCP)](#using-the-model-context-protocol-mcp)
...
For more information on creating and configuring custom agents, see [Creating custom agents for Copilot coding agent](/en/copilot/how-tos/use-copilot-agents/coding-agent/create-custom-agents).

## [Pre-installing dependencies in GitHub Copilot's environment](#pre-installing-dependencies-in-github-copilots-environment)
