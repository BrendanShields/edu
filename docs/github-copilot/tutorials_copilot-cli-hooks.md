...
## [1\. Define an organizational policy](#1-define-an-organizational-policy)
...
### [Identify commands that always require review](#identify-commands-that-always-require-review)
...
### [Align with stakeholders](#align-with-stakeholders)
...
## [2\. Set up repository hook files](#2-set-up-repository-hook-files)
...
### [Create a hook configuration file](#create-a-hook-configuration-file)
...
### [Understand what this configuration does](#understand-what-this-configuration-does)
...
### [Commit and share the hook configuration](#commit-and-share-the-hook-configuration)
...
## [3\. Add a policy banner at session start](#3-add-a-policy-banner-at-session-start)
...
### [Create the session banner script (Bash)](#create-the-session-banner-script-bash)
...
### [Create the session banner script (PowerShell)](#create-the-session-banner-script-powershell)
...
### [Test the session banner](#test-the-session-banner)
...
## [4\. Log prompts for auditing](#4-log-prompts-for-auditing)
...
### [Create the prompt logging script (Bash)](#create-the-prompt-logging-script-bash)
...
### [Create the prompt logging script (PowerShell)](#create-the-prompt-logging-script-powershell)
...
### [Test the prompt logging script](#test-the-prompt-logging-script)
...
## [5\. Enforce policies with `preToolUse`](#5-enforce-policies-with-pretooluse)
...
### [Understand the `preToolUse` input](#understand-the-pretooluse-input)
...
### [Create the policy script](#create-the-policy-script)
...
#### [Example script (Bash)](#example-script-bash)
...
#### [Create the policy script (PowerShell)](#create-the-policy-script-powershell)
...
### [Test the policy script](#test-the-policy-script)
...
## [6\. Test end-to-end in the repository](#6-test-end-to-end-in-the-repository)
...
### [Validate your hook configuration file](#validate-your-hook-configuration-file)
...
### [Verify script permissions (Unix-based systems)](#verify-script-permissions-unix-based-systems)
...
### [Run a basic session](#run-a-basic-session)
...
### [Trigger tool use and verify logging](#trigger-tool-use-and-verify-logging)
...
### [Test a denied command](#test-a-denied-command)
...
### [Inspect your audit logs](#inspect-your-audit-logs)
...
### [Keep policies maintainable](#keep-policies-maintainable)
...
### [Handle exceptions carefully](#handle-exceptions-carefully)
...
For troubleshooting hooks, see [Using hooks with GitHub Copilot agents](/en/copilot/how-tos/use-copilot-agents/coding-agent/use-hooks#troubleshooting).