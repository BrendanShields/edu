...
### [Example agent profile](#example-agent-profile)
...
-   **Copilot coding agent on GitHub.com**: The agents tab and panel, issue assignment, and pull requests
-   **Copilot coding agent in IDEs**: Visual Studio Code, JetBrains IDEs, Eclipse, and Xcode
-   **GitHub Copilot CLI**
