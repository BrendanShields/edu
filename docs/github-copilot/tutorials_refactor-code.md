...
## [Optimizing inefficient code](#optimizing-inefficient-code)
...
### [Use the Copilot Chat panel](#use-the-copilot-chat-panel)
...
4.  To apply the suggested change:
    ...
    -   **In VS Code and JetBrains:** Hover over the suggestion in the chat panel and click the **Insert At Cursor** icon.
        ...
        ![Screenshot of the 'Insert at cursor' icon in the Copilot Chat panel.](/assets/cb-9909/images/help/copilot/insert-at-cursor.png)
        
    -   **In Visual Studio:** Click **Preview** then, in the comparison view, click **Accept**.
        

### [Use Copilot inline chat](#use-copilot-inline-chat)
...
## [Cleaning up repeated code](#cleaning-up-repeated-code)
...
## [Making code more concise](#making-code-more-concise)
...
## [Splitting up complex units of code](#splitting-up-complex-units-of-code)
...
## [Rewrite conditional code for better readability](#rewrite-conditional-code-for-better-readability)
...
## [Reformat code to use a different structure](#reformat-code-to-use-a-different-structure)
...
## [Improving the name of a symbol](#improving-the-name-of-a-symbol)
...
3.  **Visual Studio only:** Press Ctrl+Space.
    ...
    ![Screenshot of a dropdown list in VS Code giving alternatives for a symbol name.](/assets/cb-52618/images/help/copilot/rename-symbol.png)
