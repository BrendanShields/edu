...
## [Researching with Copilot](#researching-with-copilot)
...
4.  Open Copilot Chat and check, at the bottom of the chat view, that **Ask** is the currently selected chat mode. If it is not, select **Ask** from the chat mode dropdown.
    ...
    ![Screenshot of "Ask" being selected in the mode picker at the bottom of chat view.](/assets/cb-40921/images/help/copilot/ask-mode-selection.png)
...
## [Planning the implementation](#planning-the-implementation)
...
2.  Enter this prompt:
    ...
    > ### [Plan: Build Time-Tracking Web Application](#plan-build-time-tracking-web-application)
    > 
...
## [Building your application with Copilot coding agent](#building-your-application-with-copilot-coding-agent)
...
2.  Copilot will request your permission to perform actions such as editing sensitive files, running commands, or adding files to Git.
    ...
    -   **In VS Code:** click **Allow**.
        ...
        ![Screenshot of Copilot in VS Code asking for permission to edit a sensitive file. The "Allow" button is highlighted.](/assets/cb-156641/images/help/copilot/allow-editing-files.png)
    ...
    -   **In JetBrains:**
        ...
        -   When asked about running a command, click **Continue**.
            ...
            ![Screenshot of Copilot in JetBrains asking for permission to run a command. The "Continue" button is highlighted.](/assets/cb-55205/images/help/copilot/continue-button-jetbrains.png)
...
3.  If Copilot finishes its response without completing the installation, or if Copilot appears to have stalled, take the following remedial actions, as required:
    ...
    -   **Process is taking a long time**
        ...
        ![Screenshot of the Copilot Chat view. The spinner icon is highlighted with a red outline.](/assets/cb-30158/images/help/copilot/agent-working-spinner.png)
    ...
    -   **Copilot's response appears to be stuck**
        ...
        ![Screenshot of the cancel button at the bottom right of the chat view in VS Code.](/assets/cb-33299/images/help/copilot/chat-cancel-button.png)
...
4.  Typically, towards the end of the coding process, Copilot will request your permission to open an untrusted web page for the application:
    ...
    ![Screenshot of the 'Open untrusted web page' message.](/assets/cb-22604/images/help/copilot/open-untrusted-web-page.png)
...
1.  View your application's web page.
    ...
    ![Screenshot of an example of a time tracker app created by Copilot.](/assets/cb-276006/images/help/copilot/time-tracker-example1.png)
    
    ![Screenshot of another example of a time tracker created by Copilot.](/assets/cb-311489/images/help/copilot/time-tracker-example2.png)
...
6.  _**Optional**: if you're familiar with the type of code Copilot is writing for you._ Display the files that Copilot has changed in the editor and review the changes. You can make your own changes if required.
...
## [Iterating on changes](#iterating-on-changes)
...
7.  _**Optional**:_ Depending on your working practices—for example, if you are working in a development team—you may decide at this point, and after each significant change, to raise a pull request. This will allow you to have changes reviewed and merged into the default branch of the repository so that other people can work on the code.
...
![Screenshot an example of a time tracker app with data added by a user.](/assets/cb-1803727/images/help/copilot/time-tracker-example3.png)

## [Improving your software project](#improving-your-software-project)
