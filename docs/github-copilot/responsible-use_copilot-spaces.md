...
## [About GitHub Copilot Spaces](#about-github-copilot-spaces)
...
## [Use cases for Spaces](#use-cases-for-spaces)
...
## [Improving performance for Spaces](#improving-performance-for-spaces)
...
### [Be selective with context](#be-selective-with-context)
...
### [Keep context updated](#keep-context-updated)
...
### [Use instructions alongside sources](#use-instructions-alongside-sources)
...
### [Anchor chat in a space](#anchor-chat-in-a-space)
...
### [Verify Space’s output](#verify-spaces-output)
...
## [Limitations of GitHub Copilot Spaces](#limitations-of-github-copilot-spaces)
...
Spaces utilizes Copilot Chat which has built-in protections against harmful, hateful, or offensive content. Please report any examples of offensive content to [copilot-safety@github.com](mailto:copilot-safety@github.com).