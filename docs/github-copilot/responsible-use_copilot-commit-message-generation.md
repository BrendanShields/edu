...
## [About Copilot commit message generation](#about-copilot-commit-message-generation)
...
## [Use cases for Copilot commit message generation](#use-cases-for-copilot-commit-message-generation)
...
## [Improving Copilot commit message generation](#improving-copilot-commit-message-generation)
...
### [Use Copilot commit message generation as a tool, not a replacement](#use-copilot-commit-message-generation-as-a-tool-not-a-replacement)
...
## [Limitations of Copilot commit message generation](#limitations-of-copilot-commit-message-generation)
...
### [Replication of commit message content](#replication-of-commit-message-content)
...
### [Potential biases and errors](#potential-biases-and-errors)
