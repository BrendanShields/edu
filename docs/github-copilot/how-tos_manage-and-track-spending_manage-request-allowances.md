...
## [Setting a policy for paid usage](#setting-a-policy-for-paid-usage)
...
## [Updating budgets](#updating-budgets)
...
## [Upgrading users to Copilot Enterprise](#upgrading-users-to-copilot-enterprise)
...
## [Organization-based premium request management](#organization-based-premium-request-management)
...
### [Setting up organization-based cost centers](#setting-up-organization-based-cost-centers)
...
## [User-based premium request management](#user-based-premium-request-management)
...
### [Setting up user-based cost centers](#setting-up-user-based-cost-centers)
