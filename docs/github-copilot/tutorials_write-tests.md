...
## [Writing unit tests with Copilot Chat](#writing-unit-tests-with-copilot-chat)
...
### [Example class: `BankAccount`](#example-class-bankaccount)
...
### [Generating unit tests with Copilot Chat](#generating-unit-tests-with-copilot-chat)
...
### [Running the tests cases](#running-the-tests-cases)
...
## [Writing integration tests with Copilot](#writing-integration-tests-with-copilot)
...
### [Example class: `BankAccount` with notification services](#example-class-bankaccount-with-notification-services)
...
### [Improving on the test cases](#improving-on-the-test-cases)
...
### [Asking about areas of improvement](#asking-about-areas-of-improvement)
...
## [Using Copilot Spaces to improve test suggestions](#using-copilot-spaces-to-improve-test-suggestions)
