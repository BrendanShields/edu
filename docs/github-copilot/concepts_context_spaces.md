...
## [Why use Copilot Spaces?](#why-use-copilot-spaces)
...
## [Who can use Spaces?](#who-can-use-spaces)

Anyone with a Copilot license, including Copilot Free, can create and use Spaces.

## [Who can I share Spaces with?](#who-can-i-share-spaces-with)
...
## [Where can I use Spaces?](#where-can-i-use-spaces)
...
## [How does using Spaces affect my usage?](#how-does-using-spaces-affect-my-usage)
