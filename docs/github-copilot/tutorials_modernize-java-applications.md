...
The GitHub Copilot app modernization extension in Visual Studio Code automates Java upgrades by identifying outdated frameworks, deprecated APIs, and upgrade blockers. Copilot coding agent applies code changes, updates build files, and resolves build and CVE issues for you.
...
## [Modernization framework](#modernization-framework)
...
## [Modernization workflow overview](#modernization-workflow-overview)
...
During the modernization workflow, you may frequently be prompted by Copilot coding agent for confirmation before it performs specific actions.

### [1\. Open your Java project](#1-open-your-java-project)
...
### [2\. Start a modernization workspace](#2-start-a-modernization-workspace)
...
### [3\. Analyze your project for upgrade opportunities](#3-analyze-your-project-for-upgrade-opportunities)
...
### [4\. Apply Copilot upgrade recommendations](#4-apply-copilot-upgrade-recommendations)
...
Copilot coding agent automated changes can include:
...
### [5\. View the upgrade report and suggested next steps](#5-view-the-upgrade-report-and-suggested-next-steps)
