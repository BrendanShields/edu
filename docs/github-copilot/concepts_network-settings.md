...
## [Proxy settings for Copilot](#proxy-settings-for-copilot)
...
The administrator of your proxy server or firewall also needs to configure network settings for Copilot to work as expected. See [Copilot allowlist reference](/en/copilot/managing-copilot/managing-github-copilot-in-your-organization/configuring-your-proxy-server-or-firewall-for-copilot).
...
### [Authentication with Kerberos](#authentication-with-kerberos)
