...
## [About GitHub Spark](#about-github-spark)
...
Spark currently leverages Claude Sonnet 4. This model is subject to change.
...
### [Spark frameworks](#spark-frameworks)
...
### [Adding inference capabilities to your spark](#adding-inference-capabilities-to-your-spark)
...
## [Use cases for Spark](#use-cases-for-spark)

### [Building and deploying full stack web applications](#building-and-deploying-full-stack-web-applications)
...
### [Prototyping ideas](#prototyping-ideas)
...
## [Improving performance for Spark](#improving-performance-for-spark)
...
### [Keep your prompts specific and on topic](#keep-your-prompts-specific-and-on-topic)
...
### [Use targeted edits appropriately](#use-targeted-edits-appropriately)
...
### [Verify Spark’s output](#verify-sparks-output)
...
## [Limitations of GitHub Spark](#limitations-of-github-spark)
...
Spark has built-in protections against harmful, hateful, or offensive content. Please report any examples of offensive content to [copilot-safety@github.com](mailto:copilot-safety@github.com). Please include your spark’s URL so that we can identify the spark.
