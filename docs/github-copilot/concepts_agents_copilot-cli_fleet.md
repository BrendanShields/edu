...
## [Benefits of using `/fleet`](#benefits-of-using-fleet)
...
## [When should you use `/fleet`?](#when-should-you-use-fleet)
...
## [Relationship between `/fleet` and autopilot mode](#relationship-between-fleet-and-autopilot-mode)
