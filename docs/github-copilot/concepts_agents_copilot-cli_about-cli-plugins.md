...
## [What plugins contain](#what-plugins-contain)
...
## [Where can I get plugins?](#where-can-i-get-plugins)
...
## [Plugins compared with manual configuration](#plugins-compared-with-manual-configuration)
...
Manual configuration in a repository
