...
Copilot prompt[](https://github.com/copilot?prompt=def%20grant_editor_access\(user_id%2C%20doc_id\)%3A%0A%20%20%20%20access%20%3D%20AccessManager\(\)%0A%20%20%20%20access.assign_role\(%0A%20%20%20%20%20%20%20%20resource_type%3D%22document%22%2C%0A%20%20%20%20%20%20%20%20resource_id%3Ddoc_id%2C%0A%20%20%20%20%20%20%20%20role%3D%22editor%22%2C%0A%20%20%20%20%20%20%20%20user_id%3Duser_id%0A%20%20%20%20\)%0A%0AAdd%20a%20docstring%20to%20the%20function%20that%20explains%20what%20it%20does.)

Add a docstring to the function that explains what it does.

def grant\_editor\_access(user\_id, doc\_id):
    access = AccessManager()
    access.assign\_role(
...
### [Why GPT-4.1 is a good fit](#why-gpt-41-is-a-good-fit)
...
Copilot prompt[](https://github.com/copilot?prompt=users%20%3D%20%5B%0A%20%20%20%20%7B%22name%22%3A%20%22Alice%22%2C%20%22active%22%3A%20True%2C%20%22signup_date%22%3A%20%222023-12-10%22%7D%2C%0A%20%20%20%20%7B%22name%22%3A%20%22Bob%22%2C%20%22active%22%3A%20False%2C%20%22signup_date%22%3A%20%222023-11-05%22%7D%2C%0A%20%20%20%20%7B%22name%22%3A%20%22Charlie%22%2C%20%22active%22%3A%20True%2C%20%22signup_date%22%3A%20%222024-01-15%22%7D%0A%5D%0A%0AFilter%20the%20list%20of%20users%20to%20only%20include%20active%20users%2C%20and%20sort%20them%20by%20signup_date.)

Filter the list of users to only include active users, and sort them by signup\_date.

users = \[
    {"name": "Alice", "active": True, "signup\_date": "2023-12-10"},
    {"name": "Bob", "active": False, "signup\_date": "2023-11-05"},
    {"name": "Charlie", "active": True, "signup\_date": "2024-01-15"}
\]
...
### [Why GPT-5 mini is a good fit](#why-gpt-5-mini-is-a-good-fit)
...
![Screenshot of a shopping cart UML diagram, showing the class details for Cart, Product, User, and Order.](/assets/cb-14364/images/help/copilot/shopping-cart-uml.png)
...
### [Why GPT-5.2 is a good fit](#why-gpt-52-is-a-good-fit)
...
### [Why Claude Haiku 4.5 is a good fit](#why-claude-haiku-45-is-a-good-fit)
...
### [Why Claude Sonnet 4.5 is a good fit](#why-claude-sonnet-45-is-a-good-fit)
