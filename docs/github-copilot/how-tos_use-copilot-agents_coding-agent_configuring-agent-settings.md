...
## [Enabling or disabling built-in code quality and security validation tools](#enabling-or-disabling-built-in-code-quality-and-security-validation-tools)
...
## [Allowing GitHub Actions workflows to run automatically when Copilot pushes](#allowing-github-actions-workflows-to-run-automatically-when-copilot-pushes)
