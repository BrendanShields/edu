...
## [Benefits of using Spark](#benefits-of-using-spark)

Spark can provide a wide range of benefits at all stages of app development.

### [Build apps with natural language or code](#build-apps-with-natural-language-or-code)
...
### [Leverage AI capabilities](#leverage-ai-capabilities)
...
#### [Create a repository with two-way syncing](#create-a-repository-with-two-way-syncing)
...
#### [Leverage standard GitHub features](#leverage-standard-github-features)
...
### [Why enable Spark for your enterprise?](#why-enable-spark-for-your-enterprise)
...
Each natural-language prompt in Spark consumes four premium requests. See [GitHub Spark billing](/en/billing/concepts/product-billing/github-spark).
...
## [Develop your spark with Copilot](#develop-your-spark-with-copilot)
...
Once your spark is connected to a GitHub repository, you can use Copilot coding agent to help you to continue to build and maintain your app, while you focus on other things.

With the coding agent, you delegate specific tasks to Copilot (either by assigning an issue to Copilot, or prompting Copilot to create a pull request), and Copilot will autonomously work in the background to complete the task. Copilot coding agent can fix bugs, refactor code, improve test coverage and more.

See [About GitHub Copilot coding agent](/en/copilot/concepts/agents/coding-agent/about-coding-agent).

## [Sharing your spark](#sharing-your-spark)
...
## [Limitations of Spark](#limitations-of-spark)
