...
### [What problem do custom instructions solve?](#what-problem-do-custom-instructions-solve)
...
### [When should you use custom instructions?](#when-should-you-use-custom-instructions)
...
### [When shouldn't you use custom instructions?](#when-shouldnt-you-use-custom-instructions)
...
### [Find out more about custom instructions](#find-out-more-about-custom-instructions)
...
### [What problem does a skill solve?](#what-problem-does-a-skill-solve)
...
### [How do you access skills?](#how-do-you-access-skills)
...
### [When should you use a skill?](#when-should-you-use-a-skill)
...
### [When shouldn't you use a skill?](#when-shouldnt-you-use-a-skill)
...
### [Find out more about agent skills](#find-out-more-about-agent-skills)
...
### [What problem do tools solve?](#what-problem-do-tools-solve)
...
### [When should you use tools?](#when-should-you-use-tools)
...
### [Find out more about allowing or denying tools](#find-out-more-about-allowing-or-denying-tools)
...
### [What problem do MCP servers solve?](#what-problem-do-mcp-servers-solve)
...
### [When should you use an MCP server?](#when-should-you-use-an-mcp-server)
...
### [When shouldn't you use an MCP server?](#when-shouldnt-you-use-an-mcp-server)

Avoid adding MCP servers when:

-   Built-in tools already cover your needs.

### [Find out more about MCP servers](#find-out-more-about-mcp-servers)
...
When the main agent stops without an error.

`subagentStop`

When a subagent completes.

### [What problem do hooks solve?](#what-problem-do-hooks-solve)
...
### [When should you usehooks?](#when-should-you-usehooks)
...
### [When shouldn't you use hooks?](#when-shouldnt-you-use-hooks)
...
### [Find out more about hooks](#find-out-more-about-hooks)
...
### [What problem do subagents solve?](#what-problem-do-subagents-solve)
...
### [When are subagents used?](#when-are-subagents-used)
...
### [What problem do custom agents solve?](#what-problem-do-custom-agents-solve)
...
### [When should you use a custom agent?](#when-should-you-use-a-custom-agent)
...
### [When shouldn't you use a custom agent?](#when-shouldnt-you-use-a-custom-agent)
...
### [Find out more about custom agents](#find-out-more-about-custom-agents)
...
### [What problem do plugins solve?](#what-problem-do-plugins-solve)
...
### [When should you use a plugin?](#when-should-you-use-a-plugin)
...
### [When shouldn't you use a plugin?](#when-shouldnt-you-use-a-plugin)
...
I want Copilot to always follow our repository conventions.

**Custom instructions**

I want a repeatable workflow I can invoke on demand.

**Skills**

I want Copilot to answer questions and carry out work in my repository.

Copilot requests permission to use the appropriate **tools**

I want guardrails, policy, or automation around tool use and session events.

**Hooks**

I need Copilot to be able to use tools provided by an external service.

**MCP servers**

When working on particular tasks, I want Copilot to operate as a specialist with a constrained toolset.

**Custom agent**

I want Copilot to carry out a complex task on my behalf.

Copilot automatically uses **subagents** when appropriate.

I want to add a package of functionality to Copilot CLI without configuring it manually myself.
