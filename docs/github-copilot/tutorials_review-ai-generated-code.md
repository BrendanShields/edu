...
## [1\. Start with functional checks](#1-start-with-functional-checks)
...
## [2\. Verify context and intent](#2-verify-context-and-intent)
...
## [3\. Assess code quality](#3-assess-code-quality)
...
## [4\. Scrutinize dependencies](#4-scrutinize-dependencies)
...
## [5\. Spot AI-specific pitfalls](#5-spot-ai-specific-pitfalls)
...
## [6\. Use collaborative reviews](#6-use-collaborative-reviews)
...
## [7\. Automate what you can](#7-automate-what-you-can)
...
## [8\. Keep improving your workflow](#8-keep-improving-your-workflow)
