...
## [Defining the logic for a small, frequent task](#defining-the-logic-for-a-small-frequent-task)
...
## [Sharing knowledge with teammates](#sharing-knowledge-with-teammates)
