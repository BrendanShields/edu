...
## [Understanding how GitHub Copilot code review processes instructions](#understanding-how-github-copilot-code-review-processes-instructions)
...
### [Keep instructions short and focused](#keep-instructions-short-and-focused)
...
### [Use clear structure and formatting](#use-clear-structure-and-formatting)
...
### [Provide concrete examples](#provide-concrete-examples)
...
## [Organizing instructions across files](#organizing-instructions-across-files)
...
### [When to use repository-wide instructions](#when-to-use-repository-wide-instructions)
...
### [When to use path-specific instructions](#when-to-use-path-specific-instructions)
...
### [Breaking up complex instruction sets](#breaking-up-complex-instruction-sets)
...
## [What not to include in custom instructions](#what-not-to-include-in-custom-instructions)
...
### [Unsupported instruction types](#unsupported-instruction-types)
...
## [Testing and iterating on your instructions](#testing-and-iterating-on-your-instructions)

The best approach to creating effective custom instructions is to start small and iterate based on results.

### [Start with a minimal instruction set](#start-with-a-minimal-instruction-set)
...
### [Test with real pull requests](#test-with-real-pull-requests)
...
### [Iterate based on results](#iterate-based-on-results)
...
## [Example: Complete custom instructions for code review](#example-complete-custom-instructions-for-code-review)
...
### [Issue: Instructions are ignored](#issue-instructions-are-ignored)
...
### [Issue: Language-specific rules applied to wrong files](#issue-language-specific-rules-applied-to-wrong-files)
...
### [Issue: Inconsistent behavior across reviews](#issue-inconsistent-behavior-across-reviews)
