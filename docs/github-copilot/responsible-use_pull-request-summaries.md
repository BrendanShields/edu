...
## [About Copilot pull request summaries](#about-copilot-pull-request-summaries)
...
## [Use case for pull request summaries](#use-case-for-pull-request-summaries)
...
## [Improving performance of pull request summaries](#improving-performance-of-pull-request-summaries)

### [Use Copilot pull request summaries as a tool, not a replacement](#use-copilot-pull-request-summaries-as-a-tool-not-a-replacement)
...
![Screenshot of the bottom of a pull request comment. The feedback icons, thumbs up and thumbs down, are highlighted with a dark orange outline.](/assets/cb-41181/images/help/copilot/copilot-summary-feedback.png)

After you rate a summary as good or bad, you can provide written feedback by clicking the link that's displayed.

## [Limitations of pull request summaries](#limitations-of-pull-request-summaries)
...
### [Inaccurate responses](#inaccurate-responses)
...
### [Replication of pull request content](#replication-of-pull-request-content)
