...
## [Using the `/research` slash command](#using-the-research-slash-command)
...
## [Viewing and sharing a research report](#viewing-and-sharing-a-research-report)
...
## [Benefits of `/research`](#benefits-of-research)
...
## [Example prompts for `/research`](#example-prompts-for-research)
...
### [How a specific technology works](#how-a-specific-technology-works)
...
### [Understanding internal implementation patterns](#understanding-internal-implementation-patterns)
...
### [Comparing technologies or approaches](#comparing-technologies-or-approaches)
...
### [Process/how-to questions](#processhow-to-questions)
...
### [Deep-diving into a specific codebase component](#deep-diving-into-a-specific-codebase-component)
...
## [When you might _not_ want to use `/research`](#when-you-might-not-want-to-use-research)
...
## [Considerations and things to be aware of](#considerations-and-things-to-be-aware-of)
