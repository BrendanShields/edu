...
-   **Operation**:
    -   **Copilot coding agent** can raise pull requests for open issues.
...
### [Using Copilot Chat in ask mode](#using-copilot-chat-in-ask-mode)
...
### [Using Copilot Chat in edit mode](#using-copilot-chat-in-edit-mode)
...
### [Using Copilot Chat in agent mode](#using-copilot-chat-in-agent-mode)
