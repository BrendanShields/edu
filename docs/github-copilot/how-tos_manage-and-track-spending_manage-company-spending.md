...
## [Understanding who can grant licenses](#understanding-who-can-grant-licenses)
...
## [Managing premium requests](#managing-premium-requests)
...
### [Tracking premium request usage](#tracking-premium-request-usage)
...
### [Granting more premium requests to members](#granting-more-premium-requests-to-members)
...
## [Mapping spending to groups of users](#mapping-spending-to-groups-of-users)
...
## [Visualizing spending trends](#visualizing-spending-trends)
...
1.  Go to your enterprise or organization account settings and click **Billing & Licensing**.
...
4.  To understand spending differences between Copilot Business and Copilot Enterprise plans, select the **Group: None** dropdown menu and click **Group by: SKU**.
    ...
    ![Screenshot of the "Usage" page. A line chart tracks Copilot spending over the current month, grouped by SKU.](/assets/cb-128620/images/help/copilot/track-spending.png)
...
6.  By default, the chart and table show use grouped by models. Use the filter, "Group by", and "Timeframe" controls to show the data you want.
    ...
    ![Screenshot of the "Premium request analytics" page. A line chart tracks premium request use over the current month, grouped by model.](/assets/cb-107037/images/help/copilot/track-spending-prs.png)
